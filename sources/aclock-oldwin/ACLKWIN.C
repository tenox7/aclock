/* Aclock for Windows 2.x.
 *
 * Builds with Microsoft C 5.1 and Windows 2.0 SDK
 * Compile:  cl -c -Gsw -Zdp -FPa -Os aclkwin.c
 * Link:     link4 /noe /align:16 /map aclkwin,,,slibw,aclkwin.def
 */
...
long FAR PASCAL /*_export*/ WndProc( HWND hwnd, unsigned msg, WORD wParam, LONG lParam )
{
    TEXTMETRIC      tm;
    PAINTSTRUCT     ps;
    HFONT           hfnt;
