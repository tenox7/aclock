/*
 * aclock - ascii clock for TRS-80 Model I
 *
 ...
 * (Note: used a specially-patched version of zC
 *  with Model 3 DOS addresses replaced with Model 1's)
 *
 * zc aclockm1/c aclockm1/as
 * zas aclockm1/as aclockm1/lnk
 * zlink aclockm1/lnk aclockm1/cmd  
 ...
 *
 * Only runs on Model 1. See aclockm3.c for Model 3
 * Tested on TRSDOS 2.3, NEWDOS/80 2.0, LDOS 5.3.1
 *
 */
